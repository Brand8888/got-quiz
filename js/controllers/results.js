...
(function(){
    ...
    /*
     * attaching results controller function to the gotQuiz module
     */
    angular
        .module("gotQuiz")
    ...
    function ResultsController(quizMetrics, DataService){
        ...
        function getAnswerClass(index){
             ...
             * vm. as the object is passed by reference aka having the $index on the ng-class instead. We can manipulate
